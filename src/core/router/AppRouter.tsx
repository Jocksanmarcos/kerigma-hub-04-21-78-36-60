  ...
  return (
    <Suspense fallback={<MinimalLoader />}>
      <Routes>
        ...
        <Route path="/jornada" element={<ProtectedRoute><JornadaCrescimentoPage /></ProtectedRoute>} />
        <Route path="/jornada/trilhas" element={<ProtectedRoute><JornadaTrilhasPage /></ProtectedRoute>} />
        <Route path="/jornada/biblia" element={<ProtectedRoute><JornadaBibliaPage /></ProtectedRoute>} />
